...
public class BoardDaoImpl implements BoardDao{
    ...
    public Board getBoard(Long idParam) {
        ...
        try {
            ...
            String sql = "select id,title,content,user_id,regdate,read_count from board where id = ?";
    ...
    public void addBoard(Board board) {
        ...
        String sql = "insert into board(title,nickname,user_id,content,group_no,group_seq,group_depth) values(?,?,1,?,0,0,0)";
            ps = conn.prepareStatement(sql);
